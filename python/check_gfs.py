...
from tools_AIP import prep_proj_multi_cartopy, get_GFS_grads, get_cfeature
...
def main( gtime=datetime( 2019, 8, 24, 12, 0 ), htime=datetime( 2019, 8, 24, 12, 0 ), 
    ...
    tk1000, glon2d, glat2d = get_GFS_grads( gtime, var="TMPprs",zdim=1)
    tk0500, glon2d, glat2d = get_GFS_grads( gtime, var="TMPprs",zdim=13)

    print( np.max( tk1000 ), np.max( tk0500 ) )
    ...
    ax.contourf( glon2d, glat2d, tk0500, 
                 transform=data_crs )
    plt.show()
    sys.exit()
    ...
    if jtime == datetime(2019, 8, 24, 15, 0, 0 ):
       data_path = "../../dat4figs_JAMES/Fig08_tmp"
       ofig = "Fig08.png"
    elif jtime == datetime(2019, 8, 19, 12, 0, 0 ):
       data_path = "../../dat4figs_JAMES/Fig11_tmp"
       ofig = "Fig11.png"
    else:
       sys.exit()
