...
#        print( cname[i:i+4] )
    ...
    #       sys.exit()
        ...
        if lt_l[idx_] > 27.0*60.0:
           print( lt_l[idx_], ctime, cname )
...
ax.annotate("Obs\nreceived(10s)", xy=(xobs, 0), size=10, xytext=(xobs+0.5, -1400),
...
ofig = "hist_realtime0825_leadtime.png"
