...
fn_h = "/data_ballantine02/miyoshi-t/honda/SCALE-LETKF/AIP_SAFE/realtime_20200825/as-of-pm16-0827/result.txt"
fn_h = "/data_ballantine02/miyoshi-t/honda/SCALE-LETKF/AIP_SAFE/realtime_20200825/result_leadtime/result.txt"


# JST
stime = datetime( 2020, 8,  24, 14, 00 )
etime = datetime( 2020, 8,  24, 14, 00 )
etime = datetime( 2020, 9,   7,  12, 0 )

stime_ = datetime( 2020, 8, 24, 12, 0 )
etime_ = datetime( 2020, 8, 27, 16, 0 )
etime_ = datetime( 2020, 9, 7,  12, 0 )
...
print( np.nanmax(lt_l), np.nanargmax(lt_l), ftime_l[  np.nanargmax(lt_l) ] )
...
ofig = "realtime0826_leadtime.png"
